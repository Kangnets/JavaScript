...
function C_R4() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const url = `https://api_elec.ivyforest.kr:4002/result/vote_db_0/${dbNumber}/score4`;
  ...
  return <div className='imtext34'><span>{candidaterank1 ? candidaterank1 : "Loading..."}위</span></div>;
}
